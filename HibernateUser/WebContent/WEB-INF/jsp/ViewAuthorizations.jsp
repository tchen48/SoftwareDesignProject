				...
				<td> <b><u> Reject </u></b></td>
				  ...
				  <form:form  method="post" action="submit_authorization.html">
    				...
    				<td><c:out value="${authorization.user_id}"  /> </td>
      				...
      				<td style="text-align: center"><input type="submit" value="Authorize" align="left" onclick="show_alert()" ></td>
      				<td style="text-align: center"><input type="submit" value="Reject" align="left" onclick="show_alert1()" ></td>    				
    				</tr>
    				</form:form> 
  				</c:forEach>			      
		   		 </table>
