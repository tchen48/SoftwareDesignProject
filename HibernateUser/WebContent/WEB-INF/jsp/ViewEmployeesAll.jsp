		  ...
		  <div class="box">
				...
				<td> <b><u> Modify </u></b></td>
				  ...
				  <c:forEach var="employee" items="${list}" >
    				...
    				<td style="text-align: center"><input type="submit" name="action" value="Delete" align="left" onclick="show_alert()" ></td> 
    				<td style="text-align: center"><input type="submit" name="action" value="Modify" align="left" onclick="show_alert()" ></td>   				
    				</tr>
  				</c:forEach>			      
		   		 </table>
