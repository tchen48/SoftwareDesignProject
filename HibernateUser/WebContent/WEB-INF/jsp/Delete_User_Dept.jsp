...
<div id="wrapper">
  <div id="header">
	...
	<div id="menu">
		<ul>			
			<li><a href="DepartmentManager.html">Go Back to Account Management &emsp;</a></li>			 
	...
	<div id="page">
	  <div id="content">
		  <div class="box">
			<h3>Welcome Department Manager !!! </h3><h4>To Delete A User, Enter the UserID Below.<br><br></h4>
			<form:form  method="post" action="submit_delete_user_dept.html">
