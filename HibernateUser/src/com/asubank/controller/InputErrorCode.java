...
public class InputErrorCode {
	...
	public static final String ADDRESS_ERROR = "Only letters, numbers, and spaces are allowed in first name";
	...
	public static final String ACCOUNTID_ERROR = "Only letters are allowed in accountID";
