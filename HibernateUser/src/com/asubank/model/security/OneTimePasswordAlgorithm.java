//get from http://tools.ietf.org/html/rfc4226
...
//        }
  ...
  = {1,10,100,1000,10000,100000,1000000,10000000,100000000};
    ...
    public static void main(String[] args) throws InvalidKeyException, NoSuchAlgorithmException, ParseException{
//    	byte[] bytes = new byte[]{0,7,0,9,1,0};
//    	long movingFactor = 1310111748;
//    	int codedigit = 8;
//    	int offset = 7;
//    	
//    	String otp = generateOTP(bytes, movingFactor, codedigit, false, offset);
    	
    	String password = "Shaosh0913!!!";
